...
from classes.functionsmd import (forceXLJ3, forceYLJ3, forceZLJ3, verlet_pos,
                                 writeXYZFile)
...
posGrid = makeLatticePos(brick, N[0], N[1], N[2], 1)
        ...
        for j in range(N[1]):
            for k in range(N[2]):
                if (latticeGrid[i, j, k] == 1):
                    ...
                    fx = forceXLJ3(i, j, k, posGrid)
                    fy = forceYLJ3(i, j, k, posGrid)
                    fz = forceZLJ3(i, j, k, posGrid)
